...
/// France 컬러 팔레트 — 국기 bleu·rouge (식별자는 es 템플릿 유지) + 석회벽 백색·올리브·지중해 청색
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFF0055A4);
  static const Color rojoDeep = Color(0xFF003A75);
  static const Color rojoLight = Color(0xFF3E7CC1);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFFEF4135);
  static const Color gualdaBright = Color(0xFFFF6B5E);
  static const Color gualdaDeep = Color(0xFFB22B22);
