...
/// flutter_tts 기반 — 시스템 fr-FR voice 사용.
///
/// 화자별 음성: 기기에 남/여 fr 보이스가 있으면 voice 전환,
...
class TtsService {
  ...
  /// fr 보이스 중 이름에 male/female 힌트가 있는 것을 1회 스캔.
  Future<void> _scanVoices() async {
    ...
    try {
      ...
      for (final v in voices) {
        ...
        if (!vLocale.toLowerCase().startsWith('fr')) continue;
